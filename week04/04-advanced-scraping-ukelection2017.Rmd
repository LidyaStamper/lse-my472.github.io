...
rD <- rsDriver(browser=c("firefox"), port = 4492L)
driver <- rD[["client"]]
...
const_name <- driver$findElement(using = 'xpath', value = '/html/body/div[3]/article/div/div[2]/div/figure/figure/div[2]/div[2]/div[2]/div/p/b[2]')$getElementText() 
...
get_results_by_const <- function(const_name, sec = 4){
  ...
  search_field <- findElement(using = 'class')
 ...
 search_field$sendKeysToElement(list(key = "enter")) 
  ...
  res_div <- driver$findElement(using = 'xpath', value = 'ge-result')
