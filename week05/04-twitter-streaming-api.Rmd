...
```{r}
authentication <- list(consumer_key = "b9LzpYU3JvKLhGe9BvDVTFwAC",
                 consumer_secret = "Tj7f8weTSdTt9vysT24UFFNEAJAWgcXpnMGE1zM6YpyNjtoqZd",
                 access_token = "1349034871637700609-0H2qhnFJ7ixFoI3hX85D9ODBrD1w9e",
                 access_token_secret = "fJeGUWnDR9bQcmBso3EKVXCtqB2vc1Zf6ejjatOareM5Q")
```
...
twitter_token <- create_token(app = "APIMY472", 
...
```{r}
keywords_tweets <- stream_tweets("stopthesteal", timeout = 5)
...
ggplot(map.data) + geom_map(aes(map_id = region), map = map.data, fill = "grey90", 
    ...
    geom_point(data = geo_tweets, aes(x = lng, y = lat), size = 3,
               alpha = 1/5, color = "red") +
